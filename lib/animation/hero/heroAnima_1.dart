 ...
 * hero   动画  飞行动画 demo
 */
class HeroAnimaWidget_1 extends StatefulWidget {
  @override
  State createState() => new HeroAnimaWidgetState();
}
      ...
      children: [
        Expanded(
            child: Column(
              ...
              children: [
                Text('2019-06-19  周四', style: TextStyle(fontSize: 12),),
  ...
  Widget _getListView() {
    return ListView.builder(
      itemBuilder: (context, itemIndex) {
        return _getListViewItem(this._games[itemIndex]);
      },
      shrinkWrap: true,
